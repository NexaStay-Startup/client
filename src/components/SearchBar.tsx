...
export default function NexaStayTextarea({ fullscreen, setFullscreen, width, height, fullHeight }: NexaStayTextareaProps) {
    ...
    return (
        <div className="p-[1px] rounded-[22px] bg-nexastay-border shadow-nexastay-default">
            <div
                className="flex flex-col justify-between rounded-[22px] bg-white p-[12px_18px] "
                style={{
                    width: `${width}px`,
                    height: `${fullscreen ? fullHeight : height}px`
                }}
        >
            {/* Textarea wrapper */}
            ...
            {/* Buttons row */}
                <div className="flex items-center justify-end gap-[16px] mt-1">
                    {/*Enhancement button*/}
                <button className="w-[34px] h-[34px] flex items-center justify-center group">
                        <svg width="34" height="34" viewBox="0 0 34 34" fill="none" xmlns="http://www.w3.org/2000/svg" className="block group-hover:hidden">
                        ...
                        <svg width="34" height="34" viewBox="0 0 34 34" fill="none" xmlns="http://www.w3.org/2000/svg" className="hidden group-hover:block">
                    ...
                    {/*Voice Button*/}
                    <button
                        className="w-[34px] h-[34px] flex items-center justify-center group"
                    ...
                    {/*Fullscreen Button*/}
                <button className="w-[34px] h-[34px] flex items-center justify-center group" onClick={() => setFullscreen(!fullscreen)}>
                        <svg width="34" height="34" viewBox="0 0 34 34" fill="none" xmlns="http://www.w3.org/2000/svg" className="block group-hover:hidden">
                    ...
                    {wordCount > 0 && (
                        <div className="flex items-center gap-[10px] w-[86px] h-[28px]">
                            {/* Percentage text */}
